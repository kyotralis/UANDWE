...
const features = [
  { title: "Web Application Development", icon: <Code size={28} /> },
  { title: "Mobile App Development", icon: <Smartphone size={28} /> },
  { title: "Cloud Integration", icon: <Cloud size={28} /> },
  { title: "API Development", icon: <Server size={28} /> },
  { title: "UI/UX Design", icon: <Palette size={28} /> },
  { title: "AI & Data Integration", icon: <Brain size={28} /> },
];
...
const Application = () => {
  return (
    <div className="relative pt-32 pb-20 bg-gradient-to-br from-[#1a0f05] via-[#2b1406] to-[#140a03] text-white overflow-hidden">
      ...
      <div className="absolute w-[400px] h-[400px] bg-amber-400/20 blur-[120px] rounded-full bottom-[-100px] right-[-100px]" />
      ...
      <div className="text-center mb-16 relative z-10">
        ...
        >
          We craft scalable, high-performance web and mobile applications
